    ...
    <div class="container mx-auto flex justify-center items-center">
      <div class="hidden md:flex md:items-center md:justify-center w-full md:w-auto" id="nav-content">
        <ul class="text-black flex justify-center bg-white rounded-full">
          <li class="block px-4 mx-1 hover:font-medium rounded-md flex items-center" >
               <span>
          ...
          <li class="block px-4 mx-1 hover:font-medium rounded-md flex items-center">
            ...
            <RouterLink activeClass="font-medium" :to="{name: 'projects' }" class="px-4 py-2 duration-150 transition-all rounded-xl ">
              Work
            </RouterLink>
          </li>
          <li class="block px-4 mx-1 hover:font-medium rounded-md flex items-center">
          <span>
            ...
            <RouterLink activeClass="font-medium" to="/blogs"
                        class="px-4 py-2 duration-150 transition-all rounded-xl "
            >
              Blogs
            </RouterLink>
